...
if load_models:
    ...
    param_grid = {'n_estimators': [10, 100, 1000],
                  ...
                  'max_depth': [1, 2, 4, 6],
                  'min_samples_leaf': [3, 5, 9, 17, 25],
                  'max_features': [1.0, 0.3, 0.1]}
    sup_estimator = GradientBoostingRegressor(criterion="mae")
    sup_estimator = GridSearchCV(estimator=sup_estimator, param_grid=param_grid,
...
if load_models:
    ...
    param_grid = {'n_estimators': [10, 100, 1000],
                  ...
                  'min_samples_leaf':[3,5,9,17,25],
                  'max_features':[1.0,0.3,0.1] }
    tot_estimator = GradientBoostingRegressor(criterion="mae")
    tot_estimator = GridSearchCV(estimator = tot_estimator, param_grid = param_grid,
                          cv = 3, n_jobs = -1, verbose = 2, scoring="neg_mean_absolute_error")
...
pickle.dump(sup_estimator, open("sup_estimator.pkl", 'wb'))
pickle.dump(tot_estimator, open("tot_estimator.pkl", 'wb'))
