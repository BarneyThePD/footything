...
if load_models:
    ...
    pipe = Pipeline([('scaler', StandardScaler()), ('grad_boost', GradientBoostingRegressor(criterion="mae"))])
...
pickle.dump(sup_estimator, open("sup_estimator_pre.pkl", 'wb'))
pickle.dump(tot_estimator, open("tot_estimator_pre.pkl", 'wb'))
